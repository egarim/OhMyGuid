...
namespace OhMyGuid.Tests
{
    ...
    public class COMBGuidTest
    {
        ...
        public void TestGuidsAreUnique()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                Guid guid = GuidService.NewTimeBasedGuid();
        ...
        {
            Guid first = GuidService.NewTimeBasedGuid();
            Thread.Sleep(1);
            Guid second = GuidService.NewTimeBasedGuid();
            Thread.Sleep(1);
            Guid third = GuidService.NewTimeBasedGuid();
        ...
        public void TestGuidsAreSortableAndMaintainOrder()
        {
            ...
            {
                Thread.Sleep(1);
                var guid = GuidService.NewTimeBasedGuid();
